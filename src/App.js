...
const AccountDetailModal = ({ isOpen, onClose, account, tradeHistory }) => {
    // PINDAHKAN: Blok useMemo dipindahkan ke atas sebelum if
    const accountHistory = useMemo(() => {
        // Pengecekan dipindahkan ke sini agar lebih aman
    ...
    // KONDISI: Pengecekan dan return null sekarang berada setelah Hook
