      ...
      <div className="max-w-7xl mx-auto">
        <header className="mb-4 flex flex-wrap justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <button onClick={() => setIsNotifEnabled(!isNotifEnabled)} title="Notifikasi Browser" className={`p-2 rounded-lg transition-colors ${isNotifEnabled ? 'bg-green-500/20 text-green-400' : 'bg-slate-700 text-slate-400 hover:bg-slate-600'}`}>
              <BellRing size={20} />
            </button>
